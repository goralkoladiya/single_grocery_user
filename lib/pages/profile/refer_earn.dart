                    ...
                    Container(
                      ...
                      child: TextButton(
                        ...
                        onPressed: () {
                          Share.share(
                            currencyposition == "1"
                                ? '${LocaleKeys.Use_this_code.tr()} $user_refer_code ${LocaleKeys.to_register_with.tr()} ${LocaleKeys.Single_Grocery.tr()} ${LocaleKeys.get_bonus_amount.tr()} $currency$_reffer_amount \n \n $Androidapplink \n \n $Iosapplink  '
                                : '${LocaleKeys.Use_this_code.tr()} $user_refer_code ${LocaleKeys.to_register_with.tr()} ${LocaleKeys.Single_Grocery.tr()} ${LocaleKeys.get_bonus_amount.tr()} $_reffer_amount$currency \n \n $Androidapplink \n \n $Iosapplink  ',
                          );
                        },
                      ),
                    )
