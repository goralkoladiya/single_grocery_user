...
class itemmodel {
  ...
  @override
  String toString() {
    return 'itemmodel{favoriteId: $favoriteId, id: $id, itemName: $itemName, itemType: $itemType, preparationTime: $preparationTime, price: $price, availableQty: $availableQty, isFavorite: $isFavorite, isCart: $isCart, itemQty: $itemQty, tax: $tax, imageName: $imageName, imageUrl: $imageUrl, itemDescription: $itemDescription, categoryInfo: $categoryInfo, subcategoryInfo: $subcategoryInfo, hasVariation: $hasVariation, attribute: $attribute, variation: $variation, addons: $addons}';
  }
