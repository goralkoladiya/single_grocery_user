...
class homescreenmodel {
  ...
  @override
  String toString() {
    return 'homescreenmodel{status: $status, message: $message, trendingitems: $trendingitems, todayspecial: $todayspecial, recommendeditems: $recommendeditems, checkaddons: $checkaddons, environment: $environment, appdata: $appdata, getprofile: $getprofile, cartdata: $cartdata, banners: $banners, categories: $categories, testimonials: $testimonials}';
  }
}
